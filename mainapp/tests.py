...
class TestCoursesWithMock(TestCase):
    fixtures = (
        "authapp/fixtures/001_user.json",
    ...
    def test_page_open_detail(self):
        ...
        with open("mainapp/fixtures/001_feedback_list_1.bin", "rb") as inpf, mock.patch(
...
class TestNewsSelenium(StaticLiveServerTestCase):
    fixtures = (
        "authapp/fixtures/002_user.json",
        "mainapp/fixtures/002_news.json",
    )
    ...
    def setUp(self):
        ...
        self.selenium.find_element("id", "id_username").send_keys("django")
        self.selenium.find_element("id", "id_password").send_keys("geekbrains")
        button_enter.click()
        # Wait for footer
